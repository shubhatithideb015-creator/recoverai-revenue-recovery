      ...
      if (normalized.id === 'txn_rec_80191') {
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            messageCopy: 'Hi Aarav, your card for CloudScale SaaS Pro has expired. Update your billing details securely to keep your subscription active: https://rzp.io/i/recov_80191',
            delayMinutes: 0,
            expiryHours: 72,
        ...
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            recommendedDiscountPercent: 0,
            messageCopy: 'Hi Priya, your ₹3,499 payment to UrbanKicks India was interrupted due to a bank server timeout. Complete your order in 1 tap here: https://rzp.io/i/recov_80192',
            delayMinutes: 0,
            expiryHours: 24,
        ...
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            recommendedDiscountPercent: 0,
            messageCopy: 'Dear Vikramaditya, your Apex Logistics invoice payment of ₹85,000 was interrupted. Your account manager has reserved your cluster renewal: https://rzp.io/i/recov_80193',
            delayMinutes: 0,
            expiryHours: 72,
        ...
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            messageCopy: 'Hi Rohan, your ₹1,499 payment on CodeMaster Academy was paused. Use code LEARN10 for 10% off when you complete your order: https://rzp.io/i/recov_80194',
            delayMinutes: 30,
            expiryHours: 48,
        ...
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            recommendedDiscountPercent: 0,
            messageCopy: 'Hi Ananya, your ₹18,999 order at GizmoHub India is reserved. Complete your checkout securely with 1 tap: https://rzp.io/i/recov_80195',
            delayMinutes: 0,
            expiryHours: 24,
        ...
        normalized.diagnosis = {
          ...
          proposedIntervention: {
            ...
            recommendedDiscountPercent: 0,
            messageCopy: 'Hi Kavita, your AirFly booking of ₹24,500 reached your bank UPI limit. Complete your booking via Card or Netbanking: https://rzp.io/i/recov_80196',
            delayMinutes: 0,
            expiryHours: 12,
    ...
    case 'HARD_DECLINE_CARD_EXPIRED':
      return {
        ...
        proposedIntervention: {
          ...
          recommendedDiscountPercent: 0,
          messageCopy: `Hi ${customer}, your payment of ₹${amountFormatted} for ${merchant} couldn't process because your card expired. Update payment details securely here: https://rzp.io/i/recov_${(txn.id || 'order').replace(/[^a-zA-Z0-9]/g, '')}`,
          delayMinutes: 0,
          expiryHours: 72,
    ...
    case 'SOFT_DECLINE_NETWORK':
      return {
        ...
        proposedIntervention: {
          ...
          messageCopy: `Hi ${customer}! We noticed a temporary bank switch delay with your ₹${amountFormatted} order at ${merchant}. Your cart is reserved! Tap here to complete it instantly via UPI: https://rzp.io/i/recov_${(txn.id || 'order').replace(/[^a-zA-Z0-9]/g, '')}`,
          delayMinutes: 2,
          expiryHours: 6,
    ...
    case 'INSUFFICIENT_FUNDS':
      return {
        ...
        proposedIntervention: {
          ...
          recommendedDiscountPercent: 0,
          messageCopy: `Hi ${customer}, your payment of ₹${amountFormatted} at ${merchant} was declined. Retry anytime or choose an alternate card/UPI: https://rzp.io/i/recov_${(txn.id || 'order').replace(/[^a-zA-Z0-9]/g, '')}`,
          delayMinutes: 60,
          expiryHours: 48,
    ...
    default:
      return {
        ...
        proposedIntervention: {
          ...
          recommendedDiscountPercent: 0,
          messageCopy: `Hi ${customer}, your ₹${amountFormatted} payment to ${merchant} was interrupted. Tap here to complete securely: https://rzp.io/i/recov_${(txn.id || 'order').replace(/[^a-zA-Z0-9]/g, '')}`,
          delayMinutes: 1,
          expiryHours: 24,
